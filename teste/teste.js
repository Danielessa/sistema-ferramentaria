document.addEventListener('DOMContentLoaded', function() {
    ...
    btnAdicionarPeloId.addEventListener('click', function() {
        ...
        if (idFerramenta) {
            fetch(`/api/ferramentas/${idFerramenta}`)
                ...
                .then(ferramenta => {
                    verificarCautela(ferramenta.nome);
                })
                .catch(error => {
    ...
    function verificarCautela(nomeFerramenta) {
        ...
        .then(data => {
            if (!data.cautelada) {
                adicionarFerramentaTabela(nomeFerramenta);
            } else {
    ...
    function adicionarFerramentaTabela(nomeFerramenta) {
